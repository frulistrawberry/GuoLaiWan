...
public class FrescoUtil {
    ...
    private static final String APP_IMAGE = "image";               //应用图片存储目录名
    ...
    public static ImagePipelineConfig getImagePipelineConfig(Context context) {
        ...
        imagePipelineConfigBuilder.setEncodedMemoryCacheParamsSupplier(new Supplier<MemoryCacheParams>() {
            ...
            public MemoryCacheParams get() {
                ...
                LogUtil.i("当前图片内存分配总大小", MAX_MEMORY_CACHE_SIZE);
        ...
        imagePipelineConfigBuilder.setMainDiskCacheConfig(DiskCacheConfig.newBuilder(context).setBaseDirectoryPath(context.getExternalCacheDir()).setBaseDirectoryName
                (APP_IMAGE).setMaxCacheSize(MAX_DISK_CACHE_SIZE).build());
    ...
    public  void loadImageWrapContent(final SimpleDraweeView iv, String url) {
    ...
    private  void updateIv(SimpleDraweeView iv, ImageInfo imageInfo) {
...
//        setHierarchay(simpleDraweeView.getHierarchy());
    ...
    public void loadGif(SimpleDraweeView simpleDraweeView, String uri){
        ...
        if (blurEnable) {
            builder.setPostprocessor(new BasePostprocessor() {
                ...
                public void process(Bitmap bitmap) {
                    BlurUtil.rsBlur(AppUtils.getAppContext(), bitmap, 15);
