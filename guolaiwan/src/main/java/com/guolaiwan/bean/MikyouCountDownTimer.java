...
import com.guolaiwan.ui.widget.MikyouBackgroundSpan;
...
public class MikyouCountDownTimer extends CountDownTimer{
   ...
   //用于倒计时样式的内间距,字体大小,字体颜色,倒计时间隔的颜色
    ...
    public void onFinish() {
        ...
        mCountDownTimerCallBack.onTimeCountDownFinish();
    }

    private CountDownTimerCallBack mCountDownTimerCallBack;
    public MikyouCountDownTimer setCountDownTimerCallBack(CountDownTimerCallBack countDownTimerCallBack){
