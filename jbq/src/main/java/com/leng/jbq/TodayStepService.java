...
import static com.leng.jbq.SportStepJsonUtils.getCalorieByStep;
import static com.leng.jbq.SportStepJsonUtils.getDistanceByStep;
...
public class TodayStepService extends Service implements Handler.Callback {
    ...
    private void initNotification(int currentStep) {
        ...
        if (0 != smallIcon) {
            ...
            builder.setSmallIcon(com.leng.jbq.R.mipmap.ic_notification_default);// 设置通知小ICON
        }
        ...
        builder.setTicker(getString(com.leng.jbq.R.string.app_name));
